...
SYMATTR SpiceModel FFT
SYMATTR Prefix x
SYMATTR Description FFT (CFT) up to N=31; for more, see the .sub file. {f} [Hz] is the frequency. The outputs need bus naming, else they're hard or'ed.
